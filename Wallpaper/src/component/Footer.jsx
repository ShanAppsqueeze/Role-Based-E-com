      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="text-2xl font-bold text-indigo-400 block">
              YourBrand
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/web-design" className="text-gray-400 hover:text-white transition duration-300">
                  Web Design
                </Link>
              </li>
              <li>
                <Link to="/services/app-development" className="text-gray-400 hover:text-white transition duration-300">
                  App Development
                </Link>
              </li>
              <li>
                <Link to="/services/ui-ux" className="text-gray-400 hover:text-white transition duration-300">
                  UI/UX Design
                </Link>
              </li>
              <li>
                <Link to="/services/digital-marketing" className="text-gray-400 hover:text-white transition duration-300">
                  Digital Marketing
                </Link>
              </li>
              <li>
                <Link to="/services/seo" className="text-gray-400 hover:text-white transition duration-300">
                  SEO Services
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-md transition duration-300"
              >
                Subscribe
              </button>
            </form>
